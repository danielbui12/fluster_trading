...
import { ChainLinkAggregatorAccount, ChainLinkAggregatorSchema, SOL_PRICE_FEED_ID } from "./sdk/oracle";
...
describe("Fluster Trading test", () => {
  ...
  describe(" User Action", () => {
    ...
    it("Betting", async () => {
      ...
      // const accountInfo = await connection.getAccountInfo(SOL_PRICE_FEED_ID)
      // const data = borsh.deserializeUnchecked(
      //   ChainLinkAggregatorSchema,
      //   ChainLinkAggregatorAccount,
      //   accountInfo.data
      // )

      const priceSlippage = '100000000000000000'
      const setupBetting = await betting(
        ...
        currency.publicKey,
        {
          ...
          priceSlippage: new anchor.BN(priceSlippage),
